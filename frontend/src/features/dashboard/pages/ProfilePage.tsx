      ...
      try {
        ...
        const contributedProjects = data
          ...
          .map((p: any) => ({
            ...
            language: p.language,
            owner_avatar_url: null, // Will be fetched from GitHub if needed
            stars_count: 0,
            forks_count: 0,
          ...
          <div className="flex items-start gap-7">
            ...
            <div className="flex-1 pt-1">
              ...
              {isLoadingProfile ? (
                ...
                <h1 className={`text-[42px] font-black mb-4 tracking-tight transition-colors ${
                theme === 'dark'
                  ? 'text-[#f5f5f5]'
              ...
              {!isLoadingProfile && (
                <div className="flex items-center gap-3 flex-wrap mb-4">
                  ...
                  {profileData?.linkedin ? (
                    ...
                    <div className={`w-8 h-8 mb-1 rounded-full border-2 flex items-center justify-center cursor-not-allowed ${
                      theme === 'dark' 
                        ? 'bg-gradient-to-br from-gray-400/20 to-gray-500/10 border-gray-400/30 opacity-40' 
                        : 'bg-gradient-to-br from-gray-300/40 to-gray-400/30 border-gray-400/50 opacity-60'
                    }`} title="LinkedIn">
